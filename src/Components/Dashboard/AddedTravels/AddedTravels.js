...
const AddedTravel = () => {
  ...
  const handleAddAProduct = (e) => {
    ...
    fetch("https://stark-springs-15017.herokuapp.com/travelPost", {
      method: "POST",
      headers: {
  ...
  return (
    <div
      ...
      style={{
        height: "100vh",
        backgroundImage:
          "url(https://i.ibb.co/37nbN1h/Getty-Images-150127577-58f920153df78ca159d41100.jpg)",
          ...
          <Grid className="col-lg-5 mt-lg-2">
            {isLoading ? (
              ...
              <form onSubmit={handleAddAProduct}>
                ...
                <button
                  type="submit"
                  className=" bg-pink-800 hover:bg-pink-500 text-white font-bold py-2 px-4 rounded-full w-full"
                >
                  Add a travel
                </button>
              </form>
