  ...
  return (
    <div>
      ...
      <div className=" mt-11">
        <img
          className=" w-screen"
          src="https://i.ibb.co/48K3Mr6/travel-experience-3x.jpg"
          alt=""
        />
      </div>
            ...
            <Grid className="col-sm-12 col-md-6 col-lg-6">
              ...
              <div className="flex ">
                <h4 className=" font-bold text-emerald-500">
                  Total Cost $ {travel?.price}
                </h4>
                <Rating value={4} precision={0.5} readOnly />
              </div>
              <Box>
                <Typography className="font-bold text-cyan-600">
                  Date: {travel?.date}
                </Typography>
              ...
              <Typography className=" text-justify">
                <h4 className=" text-2xl text-cyan-500">Info:</h4>{" "}
                {travel?.info}
              </Typography>
              ...
              <Box className="mt-5">
                ...
                <p className="text-yellow-500">
                  A: Kichijoji Sun Road 21/1, Tokyo.
                </p>
